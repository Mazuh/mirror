// See: https://github.com/ThaUnknown/rvfc-polyfill/tree/b7457116bebe7a77d2fff04d286286587953dcc5
    ...
    const check = (old, now) => {
      ...
      if (presentedFrames > baseline) {
        const processingDuration =
          this.mozFrameDelay || newquality.totalFrameDelay - quality.totalFrameDelay || 0;
